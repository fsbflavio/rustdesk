...
pub fn read_custom_client(config: &str) {
    ...
    // CUSTOM FORK: public key that verifies `custom.txt`. Generated by `tools/custom-signer
    // keygen`; the matching private key is kept out of git. To rotate, run keygen again and
    // replace this value. See CUSTOMIZATION.md.
    const KEY: &str = "WmVsn4zP0gwXJjKDd44volycskjdKWyogi3rE1ZhbZU=";
